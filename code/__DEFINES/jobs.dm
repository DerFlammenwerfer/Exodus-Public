...
#define JOB_DISPLAY_ORDER_MAYOR 47
#define JOB_DISPLAY_ORDER_TREASURER 48
#define JOB_DISPLAY_ORDER_MERCHANT 49
#define JOB_DISPLAY_ORDER_TAVERNKEEPER 50
#define JOB_DISPLAY_ORDER_CUSTODIAN 51
#define JOB_DISPLAY_ORDER_RESIDENT 52
